...
```bash
pip install git+https://github.com/natir/variantplaner.git@0.2.1#egg=variantplaner
```
...
pipx install git+https://github.com/natir/variantplaner.git@0.2.1#egg=variantplaner
```
